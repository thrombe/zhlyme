...
pub const ResourceManager = struct {
    ...
    pub const Uniforms = struct {
        ...
        const Params = struct {
            ...
            pheromone_ant_color_match_threshold: f32 = 0.5,
            ant_velocity: f32 = 80,
...
pub const GuiState = struct {
    ...
    fn editState(self: *@This(), app: *App, state: *AppState) void {
        ...
        _ = c.ImGui_SliderFloat("pheromone_ant_color_match_threshold", @ptrCast(&state.params.pheromone_ant_color_match_threshold), 0, 1);
